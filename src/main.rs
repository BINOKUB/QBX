// QBX Core - Révision 1.0
// Fichier : src/main.rs
// Description : Initialisation directe du Heap, enregistrement du contexte mémoire et boucle asynchrone
...
fn kernel_main(boot_info: &'static BootInfo) -> ! {
    ...
    // Sauvegarde du contexte de pagination pour permettre l'extension dynamique
